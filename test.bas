' This is a test file meant for integration testing of BASIC Wrangler.
...
INPUT C
ON C GOTO _930,_990,_1100,_2480,_990,_1050,_1100,_1150,_1190,_1330,_1420,_1440,_1550,_1560,_1620,_1630,_1770,_1810,_1850,_1980,_2090,_2120
...
A$=INKEY$
IF A$="" THEN _2190
DATA 314,314,54,54,38,96,24,1,21,17,6,14,6
C=VAL(A$)
IF C=Z THEN RETURN
E=Z
IF A(V*C)<=Z THEN E=N
...
R=((RND(Y)*F)*O/F)+Y
RETURN
DATA 30,30,0,0,6,1,4,1,1,1,50,4,2
_2330:
	' DING ROUTINE
FOR J=Z TO G
NEXT J
