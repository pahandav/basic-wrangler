...
def main():
    ...
    parser_convert.add_argument('-b', '--basic-type', dest='basic_type', choices=basdefs.get_basic_dialects(True), metavar='BASIC_Type', help='Specify the BASIC dialect to use.')
